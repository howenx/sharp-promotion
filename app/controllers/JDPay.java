...
public class JDPay extends Controller {
     ...
     * @throws Exception
     */
    public Map<String, String> getParams(Long timeInMillis, Map<String, String[]> req_map, Map<String, String[]> body_map, Long userId, Long orderId) throws Exception {
     ...
     * @throws Exception
     */
    public Map<String, String> getOrderInfo(Long userId, Long orderId) throws Exception {
                    ...
                    try {
                        ...
                        if (orders.size()>0){
                            ...
                            if (order.getOrderType() != null && order.getOrderType() == 2) { //1:正常购买订单，2：拼购订单
                                ...
                                if (pinUser.isOrMaster()) params.put("pinActivity",PROMOTION_URL+"/promotion/pin/activity/pay/"+order.getPinActiveId()+"/1");
